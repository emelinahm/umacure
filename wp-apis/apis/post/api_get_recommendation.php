...
/**
 * Get list post of recommendation
 *
 * @author NTQ-SOFT
 */
class api_get_recommendation extends api_response {
    ...
    public function __construct() {
        ...
        $this->args = array(
            ...
            'category__in' => self::$RECOMMENDATION_CATE,
            'post_status' => 'publish',
            'orderby'    => 'post_date',
            'order'      => 'DESC'
        );
    ...
    protected function execute() {
        ...
        //Get category name
        $category_name = '';
        $category = get_category(self::$RECOMMENDATION_CATE);
        if (!empty($category)) {
