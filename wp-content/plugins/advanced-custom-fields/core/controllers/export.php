...
class acf_export
{
	...
	*/
	...
	{
		// add page
		$page = add_submenu_page('edit.php?post_type=acf', __('出力','acf'), __('出力','acf'), 'manage_options', 'acf-export', array($this,'html'));
...
<div class="wrap">
	...
	<h2 style="margin: 4px 0 25px;"><?php _e("出力",'acf'); ?></h2>
		<?php
...
<div class="wp-box">
	<div class="title">
		<h3><?php _e("フィールドグループを出力",'acf'); ?></h3>
	</div>
	<table class="acf_input widefat">
		<tr>
			<td class="label">
				<label><?php _e("フィールドグループ",'acf'); ?></label>
				<p class="description"><?php _e("出力されるフィールドグループを選択してください。",'acf'); ?></p>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<ul class="hl clearfix">
					<li>
						<input type="submit" class="acf-button" name="export_to_xml" value="<?php _e("XMLに出力",'acf'); ?>" />
					</li>
					<li>
						<input type="submit" class="acf-button" name="export_to_php" value="<?php _e("PHPに出力",'acf'); ?>" />
					</li>
				</ul>
			</td>
		</tr>
